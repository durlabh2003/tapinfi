...
function ProductCard({ title, price, image, delay, comingSoon, linkTo }: { title: string; price: string; image: string; delay: string; comingSoon?: boolean; linkTo: string }) {
  return (
    <div
      data-sr-card
      data-delay={delay}
      className="relative w-full max-w-[380px] h-[480px] rounded-[32px] border-2 border-white/80 bg-[#0F172A]/40 backdrop-blur-2xl p-10 flex flex-col items-center transition-all duration-500 hover:scale-[1.03] hover:bg-[#0F172A]/60 group shadow-[0_30px_70px_rgba(0,0,0,0.4)]"
    >
...
function Website() {
  return (
    <div className="relative bg-[#020617] w-full max-w-full min-h-screen overflow-x-clip flex flex-col items-center" data-name="Website">
